...
%%
%% \ifsneighbor will control whether the scattering atom is displayed
%% \ifscattrer  will control whether the backscattered photo-electron is displayed
%%
\newif\ifscatter
\newif\ifneighbor

\scatterfalse   %% show scattered photo electron?
\neighbortrue %% show neighbor atom?
